...
output_dir = f"{PARAMS.output_dir}/virgo"
...
if __name__ == "__main__":
    ...
    ts = fits.open(f'{data_dir}/VIRGO-SPM-RED-L2-MISSIONLONG.fits')
    ...
    savedict['m'] = m
    savedict['teff'] = teff
    saveh5(f"{output_dir}/virgo-N{int(ARGS.Navg)}-s{int(ARGS.Nshift)}.h5", savedict)
